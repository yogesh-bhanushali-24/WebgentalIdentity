...
namespace WebgentalIdentity.Service
{
    public class EmailService : IEmailService
    {
        ...
        {
            userEmailOptions.Subject = UpdatePlaceHolders( "Hello{{UserName}}  this is test mail ",userEmailOptions.PlaceHolders);
            userEmailOptions.Body = UpdatePlaceHolders( GetEmailBody("TestEmail"),userEmailOptions.PlaceHolders);
            await SendEmail(userEmailOptions);
        }

        public async Task SendEmailConfirmationEmaill(UserEmailOptions userEmailOptions)
        {
